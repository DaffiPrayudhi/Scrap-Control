            ...
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item dropdown">
                    ...
                    <div class="dropdown-menu dropdown-menu-lg dropdown-menu-right">
                        ...
                        <a href="<?= base_url('admnfa/profilefa'); ?>" class="dropdown-item">
            ...
            <div class="sidebar">
                ...
                <nav class="mt-2">
                    <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                        <li class="nav-item">
                            <a href="<?= base_url('admnfa/dashboardfa'); ?>" class="nav-link">
                        ...
                        <li class="nav-item">
                            <a href="<?= base_url('admnfa/part_number_scrap_fa'); ?>" class="nav-link">
                    ...
                    if(response.length > 0) {
                        ...
                        response.forEach(function(notification) {
                            $('#notification-list').append(
                                '<li><a href="processing_form_fa"> Solder Paste Open - ' + notification.lot_number + ' - ' + notification.id + '</a></li>'
                            );
                        });
                    } else {
